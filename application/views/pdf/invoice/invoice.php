<html>
	...
	<body>
		<img src="/assets/img/circle-logo.png" width="100">
		...
		<h5 class="t-r">No : <?=$info['invoice_number']; ?></h5>
		<h4 class="center">Sales Invoice</h4>
		
		<div style="width: 50%" class="pull-left">
			<p class="f-s-12">
				Sold To : <?=$customer['company_name'];?><br>
