<div class="listview lv-bordered lv-lg">
    <div class="lv-header-alt clearfix m-b-5">
        <h2 class="lvh-label hidden-xs" id="customer-quotation-table-count">0 Record(s)</h2>
        
        <div class="lvh-search">
            <input type="text" placeholder="Start typing..." class="lvhs-input" id="customer-quotation-table-search">
        ...
        <ul class="lv-actions actions">
            ...
            <li>
                <a id="customer-quotation-table-refresh" 
                 data-toggle="tooltip" 
                 data-placement="top" 
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right" id="customer-quotation-table-status">
                    <li class="active">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right" id="customer-quotation-table-page">
                    <li class="active">
    ...
    <div class="table-responsive">
        <table id="customer-quotation-table" class="table-condensed table-hover">
            <thead>
                <tr>
