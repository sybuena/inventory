<div class="listview lv-bordered lv-lg">
    <div class="lv-header-alt clearfix m-b-5">
        <h2 class="lvh-label hidden-xs" id="inventory-job-order-table-count">0 Record(s)</h2>
        
        <div class="lvh-search">
            <input type="text" placeholder="Start typing..." class="lvhs-input" id="inventory-quotation-table-search">
        ...
        <ul class="lv-actions actions">
            ...
            <li>
                <a id="inventory-job-order-table-refresh" 
                 data-toggle="tooltip" 
                 data-placement="top" 
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right" id="inventory-job-order-table-status">
                    <li class="active">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right" id="inventory-job-order-table-page">
                    <li class="active">
    ...
    <div class="table-responsive">
        <table id="inventory-job-order-table" class="table-condensed table-hover">
            <thead>
                <tr>
