...
function convertInvoice() {
    $('.job-order-convert').unbind('click').bind('click', function() {
        var id = $(this).attr('job-order-id');
        var number = $('#job-order-number').html();

        swal({
            title : 'Convert Job Order('+number+') as Invoice?',   
            text  : 'This will create new invoice for this job order',   
            type  : 'warning',   
            ...
            if(isConfirm) {  
                ...
                var url = '/jobOrder/detail/convert/'+id;

                //loading
                swal({
                    title : "Converting job order...",   
...
function markSent() {
    ...
    $('.job-order-sent').unbind('click').bind('click', function() {
        var id = $(this).attr('job-order-id');

        swal({
            title : 'Mark Job Order as sent?',   
            text  : 'You are about to mark this job order status as sent',   
            type  : 'warning',   
            showCancelButton: true,   
            ...
            if(isConfirm) {  
                ...
                var url = '/jobOrder/detail/action/sent/'+id;
...
function markAccepted() {
    ...
    $('.job-order-accept').unbind('click').bind('click', function() {
        var id = $(this).attr('job-order-id');

        swal({
            title : 'Mark Job Order as accepted?',   
            text  : 'You are about to mark this job order status as accepted',   
            type  : 'warning',   
            showCancelButton: true,   
            confirmButtonText: 'Yes, mark this',   
            cancelButtonText: 'Nope, Im just kidding!',   
            ...
            if(isConfirm) {  
                ...
                var url = '/jobOrder/detail/action/accept/'+id;
...
function deleteJobOrder() {
	...
	$('.job-order-delete').unbind('click').bind('click', function() {
		var id = $(this).attr('job-order-id');

		swal({
            title : 'Delete Job Order?',   
            text  : 'You are about to delete this job order',   
            type  : 'warning',   
            showCancelButton: true,   
            ...
            if(isConfirm) {  
                ...
                var url = '/jobOrder/detail/delete/'+id;
                ...
                base.
                    ...
                    get(function(response) {
                        ...
                        window.location = '/jobOrder/listing/';
...
function edit() {
    $('.job-order-edit').unbind('click').bind('click', function() {
        $('#add-job-order-modal').modal('show');
        var id = $(this).attr('job-order-id');
        var url = '/jobOrder/listing/draftDetail/'+id;
        base.
            setUrl(url).
            get(function(response) {
                
                jobOrderModal(id, response.data)
            }
        );
    });
